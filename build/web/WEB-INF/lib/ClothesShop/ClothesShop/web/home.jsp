        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">With the best clothes</p>
                </div>
            </div>
        </header>
                        ...
                        <ul class="list-group category_block">
                            <c:forEach items="${listCategories}" var="C">
                                <li class="list-group-item text-white ${tag == C.cid ? 'active' : ''}">
                                    <a class="x-vip" href="category?categoryId=${C.cid}">
                                        <h5>${C.cname}</h5>
                                    </a>
                                </li>
                            </c:forEach>
                            ...
                            <c:otherwise>
                                ...
                                <nav aria-label="Page navigation example" class="d-flex justify-content-center mt-4">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item"><a class="page-link" href="home?page=${page+1}">Sau</a></li>
                                    </ul>
                                </nav>
                            </c:otherwise>
                        </c:choose>
