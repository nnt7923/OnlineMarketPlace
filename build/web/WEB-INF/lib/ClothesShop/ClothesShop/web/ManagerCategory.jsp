            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal"  class="btn btn-warning" data-toggle="modal"><span>Add New Category</span></a>
                    ...
                    <tbody>
                        <c:forEach items="${listCategories}" var="c">
                            <tr>
                                ...
                                <td>
                                    <a href="loadCategory?cid=${c.cid}"  class="edit" data-toggle="modal">Edit </a>
                                    <a href="#" class="delete" data-toggle="modal" onclick="doDelete(${c.cid})"> Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
