                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded">
                                <a href="#">
                                    <img src="${pageContext.request.contextPath}/images/${productDetails.image[0]}" class="img-fluid" alt="${productDetails.product.name}">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <h4 class="fw-bold mb-3">${productDetails.name}</h4>
                            <h5 class="product-price-show"><currency:formatCurrency value="${productDetails.priceDiscount}" /></h5>
                            <h6 class="product-price-through"><currency:formatCurrency value="${productDetails.product.price}" /></h6>
                                    ...
                                    <div class="color-options">
                                        <c:forEach items="${productDetails}" var="detail">
                                            <div class="color-option" data-color="${detail.color}" data-pdid="${detail.id}" data-criteria="${detail.criteria}" 
                                                 onclick="selectColor('${detail.color}', '${detail.product.productId}', '${detail.criteria}', '${detail.id}')">
                            ...
                            <button type="button" class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary" 
    ...
    <script>
        function addToCart(productID, productDetailId, quantity = 1) {
            $.ajax({
                ...
                data: {
                    productDetailId: productDetailId, // Gửi ID chi tiết sản phẩm
                    productId: productID, // Gửi ID của sản phẩm chính
                    quantity: quantity                // Số lượng sản phẩm cần thêm
                },
