                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="shop-detail.jsp" class="nav-item nav-link active">Shop Detail</a>
            ...
            <div class="container py-5">
                <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                <h1 class="text-primary mb-0">FireFly</h1>
...
<!--                            <a class="btn-link" href="">My Account</a>-->
                            <a class="btn-link" href="shop-detail.jsp">Shop details</a>
...
<!--                            <a class="btn-link" href="">Order History</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Address: Ha Noi</p>
                            <p>Email: nntruong79230@gmail.com</p>
...
<<<<<<<< HEAD:build/web/shop-detail.jsp
